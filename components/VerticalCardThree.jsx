...
const VerticalCardThree = ({
  ...
  return (
    ...
    } transition-all duration-500 ease-in-out flex items-center p-20 text-white montserrat text-[25px] flex-col justify-between bg-cover bg-center relative overflow-hidden border-r-2 border-black`}
    style={{
  ...
  >
    ...
    {!isExpanded ? (
      ...
      <div className="w-full h-full flex flex-col justify-between">
        ...
        <div className='text-sm montserrat text-[#000000] font-light whitespace-normal'>
          {description}
        </div>
        <button
